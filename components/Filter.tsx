              ...
              >
                <Dialog.Panel className="w-full max-w-4xl overflow-auto transform border border-wstroke rounded-md bg-wwhite p-6 text-left align-middle shadow-md transition-all">
                  ...
                  <div className="">
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-2 accent-wbg select-none my-2">
                      {filter.map((item: any) => (
                        <label
                          key={item}
                          className="rounded-md outline outline-1 outline-black py-3 px-2 text-wwhite bg-blue-500 hover:bg-blue-600 has-[:checked]:bg-blue-600"
                        >
                          <input
